...
<div class="main">
  ...
  <div class="content">
     ...
     <div style="width:300px;height:250px;">
         <form action="emplogin" method="get">
               <fieldset style="width: 300px;height: 200px;">
                   <legand><h2 style="color:green;"> Employee Login</h2></legand>
             <table width=200px, height="150px">
            
              <tr><td width="30px" align=center><lable>User_Id-</lable><lable style="color:red;">*</lable><td><input type=text name="t1"/></td></tr><tr height="10px"></tr>
              <tr><td width="30px" align=left><lable>Password-</lable><lable style="color:red;">*</lable></td><td><input type=password name="t2"/></td></tr><tr height="5px"></tr>
    ...
    </center><br/><br/>  <div class="clr"></div>
    </div>
  </div>
  <div class="fbg">
    <div class="fbg_resize">
      ...
      <div class="col c3">
        ...
        <p class="contact_info"> <span>Address:BNCET,Lucknow</span> <br />
          <span>&nbsp;</span><br />
          <span>Telephone:+011-124</span><br /><br />
          <span>FAX:</span><br />
  ...
  <div class="footer">
    <div class="footer_resize">
      <p class="lf">&copy; Copyright <a href="#">MyWebSit/a>.</p>
